        ...
        <div id="app">
          ...
          <div className="RadioGroup">
            <Radio
              ...
              attr={{
                name: "acao",
                defaultChecked: this.state.radioAcao[0] === 1,
              }}
              active={this.state.radioAcao[0] === 1 ? "true" : "false"}
              onChange={() => {
                this.setState({ radioAcao: [1, 0, 0] });
              }}
            />
            <Radio
              label="🛵 Comprar Motos"
              attr={{
                name: "acao",
                defaultChecked: this.state.radioAcao[1] === 1,
              }}
              active={this.state.radioAcao[1] === 1 ? "true" : "false"}
              onChange={() => {
                this.setState({ radioAcao: [0, 1, 0] });
              }}
            />
            <Radio
              label="🤑 Quero Vender"
              attr={{
                name: "acao",
                defaultChecked: this.state.radioAcao[2] === 1,
              }}
              active={this.state.radioAcao[2] === 1 ? "true" : "false"}
              onChange={() => {
                this.setState({ radioAcao: [0, 0, 1] });
              }}
            />
          </div>
          <Checkbox
            label="Novos"
            attr={{ name: "novo", defaultChecked: true }}
          />
          <Checkbox
            label="Usados"
            attr={{ name: "usado", defaultChecked: true }}
          />
          <br />
          <Select
          ...
          <Select
            ...
            options={this.setState.raioSelect}
          />
          <Select
            label="Marca"
            id="SelectMarca"
          ...
          <Select
            ...
            onChange={(e) => {
              this.setState({ faixaPreco: e.target.value });
            }}
            options={this.setState.faixaPrecoSelect}
          />
          <Select
            label="Versão"
            last
            ...
            onChange={(e) => {
              this.setState({ versao: e.target.value });
            }}
          ...
          <Button
            ...
            onClick={() => {
              alert("O role vai começar a ser implementado!");
            }}
          />
        </div>
      </>
